...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    # c2: 保存当前层的输出channel
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args,哪层开始，模块默认深度，模块类型，模块参数
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='yolov5_RepLKNet.yaml', help='model.yaml')
